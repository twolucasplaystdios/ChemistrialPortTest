package net.twolucasplay.chemistrialporttest.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(Chemistrial.MODID);

    public static final DeferredBlock<Block> BLOCK_OF_ZINC = registerBlock("block_of_zinc",
